...
public class Fish implements Automation {
  ...
  private static void dropInventory(Robot robot) throws InterruptedException {
    ...
    Automation.mouseGlide(robot, (int) startingPoint.getX(), (int) startingPoint.getY(), 1720, 835,
        movementTimeTo, 100);
  ...
  public void run() {
    try {
      ...
      while (true) {
        ...
        Automation.mouseGlide(robot, (int) startingPoint.getX(), (int) startingPoint.getY(),
            (int) startingPoint.getX(), (int) startingPoint.getY() + 30, movementTimeDown, 200);
        ...
        Automation.mouseGlide(robot, (int) firstMenuOption.getX(), (int) firstMenuOption.getY(),
            (int) startingPoint.getX(), (int) startingPoint.getY(), movementTimeDown, 200);
        robot.mousePress(InputEvent.BUTTON3_DOWN_MASK);
        robot.mouseRelease(InputEvent.BUTTON3_DOWN_MASK);
        Automation.mouseGlide(robot, (int) startingPoint.getX(), (int) startingPoint.getY(),
            (int) firstMenuOption.getX(), (int) firstMenuOption.getY(), movementTimeDown, 200);
        ...
        Automation.mouseGlide(robot, (int) afterAction.getX(), (int) afterAction.getY(),
            (int) startingPoint.getX(), (int) startingPoint.getY(), movementTimeDown, 200);
      }
  ...
  private void useItem(Robot robot) throws InterruptedException {
    ...
    Automation.mouseGlide(robot, (int) firstInventoryPoint.getX(), (int) firstInventoryPoint.getY(),
        (int) secondInventoryPoint.getX(), (int) secondInventoryPoint.getY(), movementTimeTo, 100);
